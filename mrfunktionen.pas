...
function MRPosEx(const SubStr: string; const S: string; Offset: Integer;
  Reverse: Boolean = False): Integer;
function OsterSonntag(Jahr: Integer): TDateTime;
function ReplaceStr(SubStr: string; Str: string; NewStr: string;
  RepAll: Boolean = false): string;
function ReplaceString(SubStr: string; Str: string; NewStr: string;
  RepAll: Boolean = false): string;
function ReverseString(Str: string): string;
function StringToHex(str: string): string;
function Trenn1000er(Wert: Int64): string;

procedure CopyArray(srcArray: TStrArray; startPosSrc: Integer;
  var dstArray: TStrArray; startPosDst: Integer; anzahl: Integer);
procedure Chomp(var Str: string);
procedure Explode(const Werte, Trenner: string; var ResArray: TDblArray;
  DblSep: TDblSep; Limit: Integer = 0; const EndeElement: Boolean = false); overload;
procedure Explode(const Werte, Trenner: string; var ResArray: TIntArray;
  Limit: Integer = 0; const EndeElement: Boolean = false); overload;
procedure Explode(const Werte, Trenner: string; var ResArray: TStrArray;
  Limit: Integer = 0; const EndeElement: Boolean = false); overload;
